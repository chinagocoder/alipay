...
func (p Code) IsSuccess() bool {
	return p == CodeSuccess
}
...
func (r *ErrorRsp) Error() string {
	return fmt.Sprintf("%s - %s", r.Code, r.SubMsg)
}
...
func (r CertDownload) APIName() string {
	return "alipay.open.app.alipaycert.download"
}

func (r CertDownload) Params() map[string]string {
